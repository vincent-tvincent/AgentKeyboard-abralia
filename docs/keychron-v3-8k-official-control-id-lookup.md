# Keychron V3 8K official default ControlId lookup
...
- **Default keymap source:** [Keychron keymap.c](https://github.com/Keychron/qmk_firmware/blob/ee7390c3bbdc1f71a1cc8d54323f3f1d97868593/keyboards/keychron/v3_8k/ansi_encoder/keymaps/keychron/keymap.c)
...
- **Generated with:** QMK `c2json --no-cpp` plus the pinned layout matrix
...
| `F1` | `[0,1]` | `0x0001` | `KC_BRID` | `KC_F1` |
| `F2` | `[0,2]` | `0x0002` | `KC_BRIU` | `KC_F2` |
| `F3` | `[0,3]` | `0x0003` | `KC_MCTRL` | `KC_F3` |
| `F4` | `[0,4]` | `0x0004` | `KC_LNPAD` | `KC_F4` |
| `F5` | `[0,5]` | `0x0005` | `UG_VALD` | `KC_F5` |
| `F6` | `[0,6]` | `0x0006` | `UG_VALU` | `KC_F6` |
| `F7` | `[0,7]` | `0x0007` | `KC_MPRV` | `KC_F7` |
| `F8` | `[0,8]` | `0x0008` | `KC_MPLY` | `KC_F8` |
| `F9` | `[0,9]` | `0x0009` | `KC_MNXT` | `KC_F9` |
| `F10` | `[0,10]` | `0x000A` | `KC_MUTE` | `KC_F10` |
| `F11` | `[0,11]` | `0x000B` | `KC_VOLD` | `KC_F11` |
| `F12` | `[0,12]` | `0x000C` | `KC_VOLU` | `KC_F12` |
| `KNOB_PRESS` | `[0,13]` | `0x000D` | `KC_MUTE` | `KC_MUTE` |
| `SCREENSHOT` | `[0,14]` | `0x000E` | `KC_SNAP` | `KC_PSCR` |
| `SCROLL_LOCK` | `[0,15]` | `0x000F` | `KC_SIRI` | `KC_CTANA` |
| `PAUSE` | `[0,16]` | `0x0010` | `UG_NEXT` | `UG_NEXT` |
...
| `INSERT` | `[1,14]` | `0x010E` | `KC_INS` | `KC_INS` |
...
The default keymap and layout facts are derived from the pinned Keychron/QMK
source linked above. Keychron and QMK retain their original notices and
